...
export default function CrossPlatformTrendingPage() {
  return (
    <div>
      <div className="mb-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold">유튜브 트렌딩</h2>
          </div>
          <div className="mt-4 space-y-3">
            <p className="text-sm text-muted-foreground">
              YouTube API 키를 설정하면 한국 트렌딩 영상이 여기에 표시됩니다.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold">인스타그램 트렌딩</h2>
          </div>
          <div className="mt-4 space-y-3">
            <p className="text-sm text-muted-foreground">
              Instagram API를 설정하면 인기 게시물이 여기에 표시됩니다.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold">쓰레드 트렌딩</h2>
          </div>
          <div className="mt-4 space-y-3">
            <p className="text-sm text-muted-foreground">
              Threads API를 설정하면 인기 게시물이 여기에 표시됩니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 rounded-xl border border-border bg-card p-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold">콘텐츠 주제 추천</h2>
        </div>
        <p className="mt-2 text-sm text-muted-foreground">
          API를 설정하고 트렌딩 데이터가 수집되면, 블로그에 적합한 콘텐츠 주제를
          자동으로 추천해드립니다.
        </p>
      </div>
    </div>
